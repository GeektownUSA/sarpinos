  ...
  return (
    <>
      ...
      <div className={styles.content}>
        ...
        <p>We take pizza and food delivery to the next level. You get fast, hot food delivery, even if it&apos;s a late night. There is no minimum order and you can take your time while using our online menu. And of course, you can always count on getting delicious pizza.</p>
      </div>
      <div className={styles.content}>

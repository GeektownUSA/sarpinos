  ...
  return (
    <>
      ...
      <div className={styles.content}>
        ...
        <p>Our menu provides so much more than pizza, serving up sandwiches, pastas, calzones, salads, sides, desserts and more! All meals are made fresh and you can also count on fast delivery when you order from Sarpino&apos;s online.</p>
      </div>
      <div className={styles.content}>
        <h5>The Only Choice for Fast Delivery in the {post.acf?.metro_area || 'your metro area'} metro area.</h5>
        <p>We take pizza and food delivery to the next level. You get fast food delivery, even if it&apos;s a late night. There is no minimum order and you can take your time while using our online menu. And of course, you can always count on getting delicious pizza from Sarpino&apos;s Pizzeria in the {post.acf?.metro_area || 'your metro area'} metro area.</p>
      </div>
      <div className={styles.content}>
      ...
      <div className={styles.content}>
        ...
        <ol className={styles.list}>
          ...
          <li>Order online using our secure website. There is no minimum order requirement for fast delivery.</li>
          <li>We will deliver your food fast right to your door.</li>
        </ol>
      </div>
      <OrderBtn />
